  ...
  return (
    <div className="min-h-[600px] pt-20 pr-5">
      ...
      <div className="relative w-full h-[600px] flex justify-end items-center">
        <div
          className="absolute inset-0 h-full w-3/4 rounded-tr-full rounded-br-full hidden md:block"
          style={{
        ...
        {/* Tarjeta */}
        <div
          className="translate-x-[0px] tablet:translate-x-[-100px] z-10 bg-white shadow-xl md:max-w-xl max-w-lg md:h-[400px] h-[550px] p-6 rounded-tl-lg text-left"
          style={{
        ...
        >
          <h4 className="text-3xl font-bold mb-4 text-left">
            ...
            <span className="text-lacampana-red2">
              {legalCertificationData.highlight}
            </span>
          </h4>
          ...
          {legalCertificationData.paragraphs.map((text, idx) => (
            <p
              key={`legal-p-${idx}`}
              className="text-gray-700 text-sm mb-4 text-left"
            >
              {text}
            </p>
          ))}
