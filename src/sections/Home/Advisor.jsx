...
const Advisor = () => {
  return (
    <section className="relative max-w-screen-desktop w-full justify-self-center overflow-hidden pb-80 tablet:py-32">
      <article className="bg-lacampana-red2 flex flex-col tablet:flex-row justify-between rounded-tl-2xl">
        ...
        <div className="tablet:relative tablet:w-1/2">
          <img className="absolute right-0  md:bottom-0 bottom-40 w-[70%] md:w-[60%] translate-x-12 md:translate-x-0" src="/images/girl.png" alt="girl" />
        </div>
      </article>
    </section>
  );
