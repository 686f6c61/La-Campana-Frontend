...
const CategoriesSidebar = ({ categories }) => {
  return (
    <div className="drawer drawer-end">
      <input id="categories-sidebar" type="checkbox" className="drawer-toggle" />
      {/* BUTTON */}
      <div className="drawer-content">
        <label htmlFor="categories-sidebar" className="btn btn-ghost drawer-button flex justify-start p-0">
