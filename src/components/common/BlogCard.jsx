...
const BlogCard = ({
  ...
  return blogsGallery ? (
    ...
    <article className="bg-lacampana-white flex flex-col p-2 rounded-br-xl w-[280px] m-h-[330px] border border-lacampana-gray1/0 hover:scale-95 transition duration-300 ease-in-out">
