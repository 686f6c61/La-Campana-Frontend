...
const Confianza = () => {
    const features = [
        {
            id: 1,
            icon: <FontAwesomeIcon icon={faWallet} className="text-red-600 text-4xl"/>,
            title: "Pagos seguros",
        ...
        {
            id: 3,
            icon: <MdOutlineSupportAgent className="mx-auto h-12 w-12 text-red-600"/>,
            title: "Asesoría permanente",
            description: "Lorem ipsum dolor sit amet consectetur. Etiam id enim diam sollicitudin ut molestie velit.",
        },
        {
            id: 4,
            icon: <FontAwesomeIcon icon={faTruckFast} className="text-red-600 text-4xl" />,
