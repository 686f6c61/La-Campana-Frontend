      ...
      <div className="w-full max-w-screen-2xl mx-60 flex items-center justify-between ">
        ...
        <div className="relative w-[260px] h-[33px]">
          <input
            ...
            className="w-full h-full px-4 py-2 text-gray-400 font-open-sans placeholder-gray-500 rounded-tl-full rounded-bl-full rounded-tr-full focus:outline-none"
          />
          <button className="absolute right-0 top-0 h-full w-12 bg-lacampana-red2 flex items-center justify-center rounded-tl-full rounded-bl-full rounded-tr-full hover:bg-red-300">
