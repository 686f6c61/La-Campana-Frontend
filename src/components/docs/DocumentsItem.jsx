...
const DocumentsItem = () => {
  ...
  // Documentos iniciales hardcodeados
  const initialDocs = [
    {
  ...
  const [allDocuments, setAllDocuments] = useState(initialDocs);
  const [displayedDocuments, setDisplayedDocuments] = useState(initialDocs);
  ...
  const loadMoreDocuments = () => {
    setAllDocuments((prevDocs) => [...prevDocs, ...additionalDocuments]);
  };
