...
const CitySelector = ({ citySelected = "City", citiesList = [], onCityChange }) => {
  return (
    <div className="dropdown dropdown-end">
      <button tabIndex={0} role="button" className="font-open-sans border-box h-8 w-fit rounded-2xl rounded-br-none hover:bg-lacampana-gray1 hover:text-white transition duration-300 ease-in-out flex items-center gap-2 bg-lacampana-gray4 px-4 py-1 text-lacampana-gray1">
